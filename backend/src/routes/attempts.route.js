...
import { answerQuestion, getAttempt, listMyAttempts, startAttempt, submitAttempt, getDetailedReview } from "../controllers/attempts.controller.js";
...
// Get Detailed Review
router.get("/:attemptId/detailed-review", verifyJWT, requireAttemptOwner, getDetailedReview);
